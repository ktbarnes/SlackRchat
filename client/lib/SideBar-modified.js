...
class SideBar extends React.Component {
  ...
  resetTouchFn(e) {
    ...
    const clientWidth = document.body.clientWidth; // this._wrapper
  ...
  render() {
    ...
    if (~[PUSH, OVER].indexOf(mode)) {
      ...
      if (side === RIGHT) {
        const end = document.body.clientWidth + _translateX; // this._wrapper
    ...
    const that = this;
    const wrapperProps = {
      ref: (comp => (that._wrapper = comp)), // this._wrapper
      style: wrapperStyle
    };
